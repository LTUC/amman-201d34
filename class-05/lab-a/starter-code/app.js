...
let sumOf2=sum(a,b);
let sumOf3=sum(sumOf2[0],c);
let mulOf2=multiply(a,b);
let mulOf3=multiply(mulOf2[0],c);
return [sumOf3[0], mulOf3[0], `${a} and ${b} and ${c} sum to ${sumOf3[0]}.`, `The product of ${a} and ${b} and ${c} is ${mulOf3[0]}.`];
